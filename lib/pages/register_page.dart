...
class _RegisterPageState extends State<RegisterPage> {
  ...
  /// 验证码
  final TextEditingController _validateNumTextController =TextEditingController();
    ...
    _nicknameFocusNode.addListener(() async {
      if(_nicknameFocusNode.hasFocus){
        ...
        final ResponseData nickData = await BjuHttp.post(
           API.existNickname,
           params: {'nickname':_nickNameTextController.text}
        ).then((onValue) =>
          ...
          Expanded(
             ...
             child: ElevatedButton(
               ...
               onPressed: _disableSendVerifyCode ? null : () async {
                ...
                ResponseData resData = await BjuHttp.post(API.sms + _mobileTextController.text.trim())
      ...
      child: OutlinedButton(
        ...
        onPressed: () async {
          ...
          //   print('手机号码有效！');
            ...
            // 验证码准确性
            final ResponseData validateData = await BjuHttp.post(
                API.verifyCode,
