...
class RecruitmentModule extends StatefulWidget {
  const RecruitmentModule({Key? key}) : super(key: key);

  @override
  State<RecruitmentModule> createState() => _RecruitmentModuleState();
}

class _RecruitmentModuleState extends State<RecruitmentModule> {

  /// 模块ID编号
  final int _moduleId = 4;
              ...
              onPressed: (){
                ...
                Navigator.of(context).push(
                    MaterialPageRoute(
                        builder: (context) =>
                            PublishPage(4)
                        //const Center(child: Text("PublishPage"),)
                    )
                );
              }, 
          ) 
