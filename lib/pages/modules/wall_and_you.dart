...
class WallModule extends StatefulWidget {
  const WallModule({Key? key}) : super(key: key);

  @override
  State<WallModule> createState() => _WallModuleState();
}
...
class _WallModuleState extends State<WallModule> {
 ...
 void _showLoadding(){
    ...
    return Container(
      ...
      child: Row(
        ...
        children:[
            ...
            VerticalDivider(indent: 30, endIndent: 30,color: Colors.grey[400],),
            Padding(
              padding: const EdgeInsets.only(top: 8, bottom: 8),
              child: GestureDetector(
  ...
  Widget _buildWallBody(){
    ...
    return (_wallDataList == null || _wallDataList.isEmpty) ? const Center(
        child:Text(
            '没有数据可提供！',
            style: TextStyle(
              fontSize: 18,
        ...
        itemBuilder: (context,index){
          return Card(
            ...
            child: Column(
              ...
              children: <Widget>[
                    // 图片区域
                    (_wallDataList[index].movingImages != null && _wallDataList[index].movingImages.isNotEmpty)
