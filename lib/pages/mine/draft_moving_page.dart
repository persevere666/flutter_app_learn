...
class _DraftMovingPageState extends State<DraftMovingPage> {
  ...
  Future<void> _initPageData() async {
    ...
    if(resData.statusCode == 1 || resData.statusCode == -1) return;
    if(!mounted) return;
    setState(() {
 ...
 Widget _bodyLayout(){
    ...
    const TextStyle noticeTextStyle =  TextStyle(
     fontSize: 18,
   ...
   return _movingList.isEmpty
       ? const Center(child: Text('暂无动态信息！',style: noticeTextStyle,),)
       : ListView.separated(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        BjuTimelineUtil.formatDateStr(_movingList[index].movingCreateTime),
                    ...
                    // 内容
                     Padding(
                      ...
                      child: Text(
                        _movingList[index].movingContent,
                        style: const TextStyle(
                          fontSize: 15,
                          fontWeight: FontWeight.w500,
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(
                            _movingList[index].movingType??'出错了',
                            style: const TextStyle(
                              fontSize: 16,
                              color: Colors.orange,
                              fontWeight: FontWeight.w500,
                        ...
                        Expanded(
                          ...
                          child: _movingList[index].movingTopics.isEmpty
                          ? Text("没有标签信息！")
                          : Wrap(
                            spacing: 1,
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () async {
                              final int? movingId = _movingList[index].movingId;
